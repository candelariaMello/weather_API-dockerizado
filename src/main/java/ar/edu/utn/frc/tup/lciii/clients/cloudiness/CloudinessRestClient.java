package ar.edu.utn.frc.tup.lciii.clients.cloudiness;
...
@Service
public class CloudinessRestClient {
    private static final String RESILIENCE4J_INSTANCE_NAME = "microTemperature";
    private static final String FALLBACK_METHOD = "fallback";
    String baseResourceUrl = "https://my-json-server.typicode.com/LCIV-2023/fake-weather/cloudiness";
    @Autowired
    private RestTemplate restTemplate;

    //@CircuitBreaker(name = RESILIENCE4J_INSTANCE_NAME, fallbackMethod = FALLBACK_METHOD)
    public CloudinessClientResponse getCloudiness(Long location_id, String datetime) {
        ResponseEntity<CloudinessClientResponse[]> response = restTemplate.getForEntity
                (baseResourceUrl +"?location_id=" + location_id+"&created_at="+datetime, CloudinessClientResponse[].class);
